...
if __name__ == "__main__":
	...
	parser.add_argument('--package', type=str, help='Secondary structure package for predictions', default='Vienna')
	...
	introns = all_introns.get_intron_by_ensembl_name(ensembl_name)
	for intron in introns:
		print(intron.print_string())
